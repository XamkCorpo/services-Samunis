...
public class CategoryService : ICategoryService
{
    ...
    public async Task<Result<List<CategoryResponse>>> GetAllAsync()
    {
        ...
        catch (Exception ex)
        {
            ...
            return Result.Failure<List<CategoryResponse>>(
                "Kategorioiden haku epäonnistui");
        }
    }
    ...
    public async Task<Result<CategoryResponse>> GetByIdAsync(int id)
    {
        ...
        {
            _logger.LogError(ex,
                "Virhe kategorian haussa: {CategoryId}",
                id);

            return Result.Failure<CategoryResponse>(
                "Kategorian haku epäonnistui");
        }
    }
        ...
        CreateCategoryRequest request)
    {
        ...
        {
            _logger.LogError(ex,
                "Virhe kategorian luomisessa: {CategoryName}",
                request.Name);

            return Result.Failure<CategoryResponse>(
                "Kategorian luominen epäonnistui");
        }
    }
        ...
        UpdateCategoryRequest request)
    {
        ...
        {
            _logger.LogError(ex,
                "Virhe kategorian päivittämisessä: {CategoryId}",
                id);

            return Result.Failure<CategoryResponse>(
                "Kategorian päivittäminen epäonnistui");
        }
    }
    ...
    public async Task<Result> DeleteAsync(int id)
    {
        ...
        {
            _logger.LogError(ex,
                "Virhe kategorian poistamisessa: {CategoryId}",
                id);

            return Result.Failure(
                "Kategorian poistaminen epäonnistui");
        }
    }
}
